...
public class ProductoController {
	...
	// :.+ es una expresión regular que permite colocar al extensión de la imagen
	@GetMapping("/uploads/img/{nombreFoto:.+}")
	public Mono<ResponseEntity<Resource>> verFoto(@PathVariable String nombreFoto) throws MalformedURLException {
		final Path ruta = Paths.get(this.path).resolve(nombreFoto).toAbsolutePath();

		final Resource imagen = new UrlResource(ruta.toUri());
